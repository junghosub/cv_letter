...
``` 1. 마켓컬리 지원 동기 및 본인의 경력 목표에 대해 기술하시오.```


``` 2. 입사지원분야와 관련한 본인의 경험을 기술하시오. (신입의 경우, 학창시절 중 수행한 프로젝트, 수업과제, 인턴경험 등을 기술해도 무방) ```

[캐셔에서 데이터 분석까지]

제가 갖춘 데이터 분석 역량을 통해 마켓컬리 프로모션 Analyst 인턴 직무에서 성과를 낼 수 있다고 느껴 지원했습니다. 해당 직무의 핵심 역량은 데이터를 통해 고객을 이해하는 것이라 생각합니다. 저는 개인 빵집 아르바이트 업무 중, 2400개의 배달 데이터 수집 및 시각화와 신제품 출시를 기획하며 해당 역량을 키웠습니다.

매장은 팬데믹으로 인해 빵 생산량 조절에 어려움을 겪고 있었습니다. 사장님이 고민하시는 모습을 보고 이 문제를 어떻게 해결할 수 있을까라는 호기심이 생겼습니다. 저는 1년간의 배달 데이터를 수집하고 시각화한다면 수요량을 예측할 수 있다고 판단했습니다. 이를 위해 웹 크롤링과 시각화에 강점이 있는 Python을 독학하여 배달의 민족 사이트에서 웹 크롤링을 진행했습니다. 데이터 전처리와 시각화를 위해 주말에도 공부하고 Kaggle의 해외 개발자들에게 조언도 구했습니다. 그 결과 제품별 생산량을 조절할 수 있었습니다. 나아가 주말 점심에 식빵 주문량이 점차 증가하는 것을 확인하여 사장님께 식빵을 사용한 브런치 메뉴 판매를 제안 드렸습니다. 이후 신제품인 '크로크무슈'를 런칭하였고, 해당 제품은 당월 배달 매출 3위를 기록했습니다.

이 경험을 바탕으로 마켓컬리 프로모션 Analyst 인턴 직무에서 고객 행동 데이터를 분석하며 실무 역량을 강화하고 싶습니다. 특히, 고객 행동을 기반으로 세분화된 고객 세그멘테이션을 진행하고 싶습니다. 이를 통해 고객 맞춤형 온사이트 프로모션을 기획 및 런칭하여 모두의 마켓컬리가 될 수 있도록 보탬이 되고 싶습니다.
