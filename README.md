...
실패를 통해 배워나가는 카카오 뱅크가 될 수 있도록 기여하겠습니다. 저는 데이콘에서 주최한 신용카드 연체 예측 공모전에 팀장으로 참여하여 성공적인 실패를 경험했습니다. 해당 공모전은 고객의 금융·비금융정보를 통해 신용도를 예측하는 공모전이었으며, 저는 분석 계획 수립 및 EDA, 베이스 라인 모델링을 담당했습니다.

초기 분석 계획은 1. 문제 정의 및 가설 설정  2. EDA를 통한 파생변수 생성 3. 베이스라인 모델링 4. 하이퍼 파라미터 튜닝 및 앙상블 모델을 통한 성능 개선으로 구성했습니다. 먼저 금융·비금융정보에 따라 신용등급의 차이가 있을 것이라는 가설 설정을 하였습니다. 하지만 예상과 달리 신용등급 간의 차이가 크지 않았고, 분석 계획과는 다른 결과에 모델링 일정은 계속 연기되었습니다. 처음 참가하는 공모전이라 의욕 넘쳤던 팀내 분위기도 점차 안 좋아졌습니다. 이런 상황을 반전시키고자 저희 팀은 모델 제출을 최우선 목표로 수정하고 업무 공유를 더욱 명확히 했습니다. 그 결과 팀원들과 협력하여 기간 내에 모델을 제출했지만 좋지 않은 성적으로 대회를 마감하게 되었습니다. 이에 낙담하지 않고 대회가 끝난 후에는 입상한 팀의 커널들을 학습하며 부족했던 부분들을 보완했습니다. 또한 좋은 팀워크를 발휘하기 위해선 명확한 업무 공유가 중요하다는 사실도 깨달았습니다.

이 경험을 통해 진정한 성공이란 실패하지 않는 것이 아닌 실패를 통해 배우고 나아가는 것이라고 느꼈습니다. 카카오 뱅크 신용리스크 모델링팀에서 진정한 성공을 통해 카카오뱅크의 신용평가모형을 개발해내고 싶습니다.

`` 2. [호기심, 원칙, 가치관, 도전, 행복, 편견, 창의성, 후회] 제시된 키워드 중 3가지 키워드를 활용하여 본인에 대해 이야기 해주세요. (800자 이내)``

[가치관 - (행복 + 도전) = 0]

저는 1+1=3을 믿는 사람입니다. 혼자보단 함께하는 사람이 되고 싶고, 데이터를 통해 어려움을 겪는 이들을 돕고싶습니다. 이러한 가치관은 개인 빵집 아르바이트를 하면서 갖게 되었습니다.

매장은 팬데믹으로 인해 빵 생산량 조절에 어려움을 겪고 있었습니다. 당일 생산, 당일 판매를 슬로건으로 내세웠기 때문에 생산량 조절 실패는 매출에 치명적이었습니다. 저는 1년간의 데이터를 수집하고 시각화한다면 수요량을 예측할 수 있다고 판단했습니다. 먼저 웹 크롤링과 데이터 시각화에 강점이 있는 Python을 독학하여 배민 사이트에서 웹 크롤링을 진행했습니다. 더 나은 시각화를 위해 일하는 주말에도 공부하고, Kaggle의 해외 개발자들에게 조언도 구했습니다. 그 결과 생산량을 조절할 수 있었고, 주말 점심에 식빵 주문량이 증가하는 것을 확인하여 사장님께 샌드위치 판매를 제안 드렸습니다. 신제품임에도 샌드위치의 매출은 3위를 기록했습니다.

이 경험은 저에게 큰 성취감과 행복감을 안겨주었고, 타인을 돕는 개발자를 목표로 나아가게 되었습니다. 사회학도가 개발자가 되기 위해선 많은 도전이 필요했습니다. 특히 머신러닝 분야를 공부할 때 많은 어려움을 겪었습니다. 이를 위해 교내 머신러닝 스터디에 참여하여 각자 이해하기 힘들었던 부분을 공유하고, 서로 해답을 제시하면서 어려움을 해소할 수 있었습니다. 이후 교내 스터디 우수팀에 선정되기도 했습니다. 이 경험을 통해 도전은 혼자보다 함께 할 때, 지속가능하고 모험적이다라는 것을 느꼈습니다. 카카오뱅크 신용리스크모델팀에서도 1+1=3을 증명하고싶습니다.
