...
실패를 통해 성공을 배운 경험으로 카카오 뱅크의 신용평가모형을 발전시키고 싶습니다. 저는 데이콘에서 주최한 신용카드 연체 예측 공모전에 팀장으로 참여하여 성공적인 실패를 경험했습니다. 해당 공모전은 고객의 금융·비금융정보를 통해 신용도를 예측하는 공모전이었으며, 저는 분석 계획 수립 및 EDA, 베이스 라인 모델링을 담당했습니다.

분석에 앞서 금융·비금융 정보에 따라 신용등급의 차이가 있을 것이라는 가설 설정을 하였습니다. 하지만 예상과 달리 신용등급 간의 차이가 크지 않았고, 분석 계획과는 다른 결과에 모델링 일정은 계속 연기되었습니다. 처음 참가하는 공모전이라 의욕 넘쳤던 팀 내 분위기도 점차 어두워졌습니다. 이런 상황을 반전시키고자 저희 팀은 모델 제출을 최우선 목표로 수정하고 업무 공유를 더욱 명확히 했습니다. 팀원들과 협력하여 기간 내에 모델을 제출할 수 있었지만 좋지 않은 성적으로 대회를 마감하게 되었습니다. 이에 낙담하지 않고 대회가 끝난 후에는 입상한 팀의 커널들을 학습하며 부족했던 부분들을 보완했습니다. 이후 팀원들과 도전한 타 공모전에선 입선이라는 결실을 맺을 수 있었습니다.

이 경험을 통해 진정한 성공이란 실패하지 않는 것이 아닌 실패를 통해 배우고 나아가는 것이라고 느꼈습니다. 또한 좋은 팀워크를 발휘하기 위해선 명확한 업무 공유가 중요하다는 사실도 깨달았습니다. 카카오 뱅크 신용리스크 모델링 팀에서 진정한 성공을 경험하며, 기존 금융권에서 소외받는 분을 위해 보다 정확한 신용평가모형을 개발하고 싶습니다.

`` 2. [호기심, 원칙, 가치관, 도전, 행복, 편견, 창의성, 후회] 제시된 키워드 중 3가지 키워드를 활용하여 본인에 대해 이야기 해주세요. (800자 이내)``

[호기심들이 모여서 도전으로]

빵집 아르바이트 경험을 통해 사회학도에서 개발자의 꿈을 키워나가게 되었습니다. 매장은 팬데믹으로 인해 빵 생산량 조절에 어려움을 겪고 있었습니다. 저는 1년간의 데이터를 수집하고 시각화한다면 수요량을 예측할 수 있다고 판단했습니다. 초기엔 엑셀을 활용했지만 데이터 수집에 큰 어려움이 있었습니다. 이후 웹 크롤링과 데이터 시각화에 강점이 있는 Python을 독학하여 배민 사이트에서 웹 크롤링을 진행했습니다. 더 나은 시각화를 위해 일하는 주말에도 공부하고, Kaggle의 해외 개발자들에게 조언도 구했습니다. 그 결과 생산량을 조절할 수 있었고, 주말 점심에 식빵 주문량이 증가하는 것을 확인하여 사장님께 샌드위치 판매를 제안 드렸습니다. 신제품임에도 샌드위치의 매출은 3위를 기록했습니다. 이 경험은 저에게 큰 성취감과 즐거움을 안겨주었습니다. 이후 통계학과 복수전공, 데이터 관련 자격증을 취득하며 개발자를 목표로 나아가게 되었습니다.

[1 + 1 = 3]

머신러닝 스터디에 참여하면서 '1 + 1 = 3'의 가치관을 갖게 되었습니다. 해당 스터디는 주차별로 자기주도적으로 학습한 후, 학습 내용을 스터디원들에게 설명하는 스터디였습니다. 또한 각자 이해하기 힘들었던 부분을 공유하고, 서로 해답을 제시해주었습니다. 이 스터디를 통해 혼자보단 함께 할 때 더욱 성장할 수 있다고 느꼈습니다. 긍정적인 스터디 분위기 덕분에 한 명도 낙오자가 발생하지 않았고, 교내 학습 동아리 우수팀에 선정되었습니다.
